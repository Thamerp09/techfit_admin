    ...
    <aside style={{ width: '280px', background: '#0f172a', padding: '30px 24px', display: 'flex', flexDirection: 'column', borderLeft: '1px solid #1e293b' }}>
      ...
      <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <div
          ...
          style={{
            padding: '14px 20px', borderRadius: '12px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '12px', transition: '0.3s',
        ...
        {/* زر إدارة المستخدمين (الجديد) */}
        <div
          onClick={() => setActiveTab('users')}
          style={{
            padding: '14px 20px', borderRadius: '12px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '12px', transition: '0.3s',
            background: activeTab === 'users' ? 'linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(239, 68, 68, 0.05) 100%)' : 'transparent',
            color: activeTab === 'users' ? '#ef4444' : '#94a3b8',
            border: activeTab === 'users' ? '1px solid rgba(239, 68, 68, 0.2)' : '1px solid transparent',
            fontWeight: activeTab === 'users' ? '700' : '500'
          }}>
          <span style={{ fontSize: '20px' }}></span> إدارة المستخدمين
        </div>
